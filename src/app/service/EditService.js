...
import { editService } from "../services/categoryService";
...
export class EditService extends Component {
  ...
  render() {
    const { editService, toggle, loading, saving, fields, errors, err } =
      this.state;
...
export default withAlert()(EditService);
