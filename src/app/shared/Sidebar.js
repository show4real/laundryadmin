    ...
    return (
      <nav className="sidebar sidebar-offcanvas" id="sidebar">
        <ul className="nav">
          ...
          <li
            className={
              this.isPathActive("/vendors") ? "nav-item active" : "nav-item"
            }
          >
          ...
          <li
            className={
              this.isPathActive("/services") ? "nav-item active" : "nav-item"
            }
          >
          ...
          <li
            className={
              this.isPathActive("/drivers") ? "nav-item active" : "nav-item"
            }
          >
          ...
          <li
            className={
              this.isPathActive("/payment-history")
                ? "nav-item active"
                : "nav-item"
            }
          >
