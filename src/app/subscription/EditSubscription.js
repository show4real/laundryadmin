...
import { editSubscription } from "../services/subscriptionService";
...
export class EditSubscription extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      id: props.editSubscription.id,
      toggle: props.toggle,
      fields: {
        name: props.editSubscription.name,
        price: props.editSubscription.price,
        days: props.editSubscription.days,
      },
      errors: {
        name: "",
        price: "",
  ...
  render() {
    const { editSubscription, toggle, loading, saving, fields, errors, err } =
      this.state;

    return (
      <Modal
        className="modal-dialog modal-dialog-centered"
        isOpen={editSubscription != null}
        ...
        <div className="col-12 grid-margin stretch-card">
          <div className="card">
            <div className="card-body">
              ...
              <h4 className="card-title">EditSubscription Subscription</h4>
...
export default withAlert()(EditSubscription);
