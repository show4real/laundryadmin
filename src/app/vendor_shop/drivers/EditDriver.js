...
import { editDriver } from "../../services/driverService";
...
export class EditDriver extends Component {
  constructor(props) {
    ...
    this.state = {
      saving: false,
      loading: false,
      editDriver: props.driver,
      status: props.driver.status == 1 ? true : false,
      id: props.driver.id,
      image: "",
      old_image: props.driver.fleet_image_url,
      toggle: props.toggle,
      fields: {
        name: props.driver.name,
        address: props.driver.address,
        fleet_number: props.driver.fleet_number,
        fleet_type: props.driver.fleet_type,
  ...
  handleSubmit = (e) => {
    const { fields, id, image, image_type_error, status } = this.state;
    ...
    if (
      ...
      const { name, email, address, fleet_number, fleet_type } = data;
              ...
              <form className="forms-sample">
                ...
                <Row>
                  ...
                  <Col md={6}>
                    ...
                    {old_image && (
                      <img src={old_image} alt="" height="100" width="100" />
                    )}
                  </Col>
                </Row>
                <Row>
...
export default withAlert()(EditDriver);
